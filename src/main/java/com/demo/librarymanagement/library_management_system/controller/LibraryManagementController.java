...
public class LibraryManagementController {
    ...
    @PostMapping(value = "/add/record", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<BookResponse> createRecords(@RequestBody BookRequest request){
